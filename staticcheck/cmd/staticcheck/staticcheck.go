...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "\tstaticcheck [flags] # runs on package in current directory\n")
	fmt.Fprintf(os.Stderr, "\tstaticcheck [flags] package\n")
	fmt.Fprintf(os.Stderr, "\tstaticcheck [flags] directory\n")
	fmt.Fprintf(os.Stderr, "\tstaticcheck [flags] files... # must be a single package\n")
