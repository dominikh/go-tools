...
func fn1() {
	...
	case io.Reader:
		println("io.Reader")
	case T: // MATCH "unreachable case clause: io.Reader will always match before CheckUnreachableTypeCases.T"
		println("T")
	}
	...
	case V:
		println("V")
	case U: // MATCH "unreachable case clause: CheckUnreachableTypeCases.V will always match before CheckUnreachableTypeCases.U"
		println("U")
	}
	...
	case U:
		println("U")
	case V: // MATCH "unreachable case clause: CheckUnreachableTypeCases.U will always match before CheckUnreachableTypeCases.V"
		println("V")
	}
}
