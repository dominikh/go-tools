...
func fnCall() {
	...
	_ = call.FunctionCallInner.F8().FunctionCallContinuedInner.F9 // want `could remove anonymous field "FunctionCallInner" from selector` `could remove anonymous field "FunctionCallContinuedInner" from selector` `could simplify selectors`
